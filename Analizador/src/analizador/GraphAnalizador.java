...
import java.io.BufferedReader; //libretia
import java.io.FileInputStream;//libretia
import java.io.FileReader;//libretia
import java.io.IOException;//libretia
import java.io.InputStreamReader;//libretia
import javax.swing.table.DefaultTableModel;//libretia
import java.io.File;//libretia
import java.io.FileWriter;//libretia
import javax.swing.JOptionPane;//libretia
...
public class GraphAnalizador extends javax.swing.JFrame {
        ...
        String linea;
        String[] lineavec = new String[100]; //declara cuanta capacidad tiene
        String[] lineavec2 = new String[100]; //declara cuanta capacidad tiene
        String[] tokens = new String[100]; //declara cuanta capacidad tiene
        String[] tokens2 = new String[100]; //declara cuanta capacidad tiene
        String[][] tablaerrores = new String[100][2]; //declara cuanta capacidad tiene
        String[][] tablasimbolos = new String[100][5]; //declara cuanta capacidad tiene
        String[] lineastripletas = new String[100]; //declara cuanta capacidad tiene
        String[][] tablaopsides = new String[8][2]; //declara cuanta capacidad tiene
        String[][] tablaopsrelides = new String[8][2]; //declara cuanta capacidad tiene
        String[][] tablatripletas = new String[100][4]; //declara cuanta capacidad tiene
        ...
        int conttripletas = 0;int conttrip = 0;int contT = 1;int contC = 1;int contTR = 1; //declara las tripletas 
        int apuntadorfor = 0; //declara apuntador1
        int apuntadorfor2 = 0;//declara apuntador2
        int apuntadorvueltafor = 0;//declara apuntador vuelta
        int apuntadorvueltafor2 = 0;//declara apuntador vuelta
        boolean banderasimbol = false; //declara si hay simbolos booleanos
        ...
        String tipodatos[] = {"int", "boolean", "double", "String" ,"for","while"};    //--Palabras Clave permitidas y funciones aritmeticas--//
        String operadores[] = {"+", "-", "*", "/", "%", "="};//--Palabras Clave permitidas y funciones aritmeticas--//
        //--Declaracion de las ventanas--//
        DefaultTableModel modelo, modelo2, modelo3;
        int numint; //declara tipo int
        boolean valbool; //declara tipo booleano
        double numdouble;//declara tipo double
        String valStr;//declara tipo string
        String tipo = "";//declara tipo string 
        //--Ruta del archivo--//
        String fichero = "Codigo.Txt"; //ruta del archivo
    ...
    public GraphAnalizador() {
        ...
        modelo = (DefaultTableModel) jTable1.getModel(); //--Tablas de la interfaz declaradas
        modelo2 = (DefaultTableModel) jTable2.getModel(); //--Tablas de la interfaz declaradas
        modelo3 = (DefaultTableModel) jTable3.getModel(); //--Tablas de la interfaz declaradas
        
        String leerCod2 = ""; //declara el string leerCod2
        try{
            File archivo2 = new File("Optimizado.txt");  //--Tablas de la interfaz declaradas
            FileWriter escribir2=new FileWriter(archivo2,false); //--Tablas de la interfaz declaradas
            OptimizarCodigo opcod2 = new OptimizarCodigo(); //--Tablas de la interfaz declaradas
        
            leerCod2 = opcod2.OptimizarCodigoDaVinci(fichero); //--Tablas de la interfaz declaradas
        ...
        try {
            FileInputStream fis = new FileInputStream(fichero2);// se hace la conexion a el archivo y muestra un mensaje
            InputStreamReader isr = new InputStreamReader(fis,"utf8");// se hace la conexion a el archivo y muestra un mensaje
            JOptionPane.showMessageDialog(null,"Se usa el archivo 'Optimizado.txt' para crear las tripletas :) \n." );
            // se hace la conexion a el archivo y muestra un mensaje
            BufferedReader br = new BufferedReader(isr);
            String lineadetexto; //se declara un string
            BufferedReader lectura;//hace la lectura 
            try {
                lectura = new BufferedReader(new FileReader(fichero));
                String codigo;//se declara un string 
                while (lectura.ready()) {//hace la lectura
                    codigo = lectura.readLine();
                    jTextArea1.setText(jTextArea1.getText() + contlineas + ":      " +  codigo + "\n");
                    contlineas++; //se adjunta lo necesario que tiene el archovo
                }
            } catch (IOException e) {}
            contlineas = 0;
            ...
            while((lineadetexto = br.readLine()) != null) {
                ...
                for (int i = 0; i < linea.length(); i++) {//--Cuenta los espacios para saber el numero de tokens--//
                    if (" ".equals(lineavec[i])) conttokens++;//--Cuenta los espacios para saber el numero de tokens--//
                }
                //--Asigna y libera un espacio a los tokens--//
                for (int i = 0; i < conttokens; i++) tokens[i] = ""; //--Asigna y libera un espacio a los tokens--//
                conttokens = 0; //--Asigna y libera un espacio a los tokens--//
                
                //--Agrega los tokens al arreglo--//
                for (int i = 0; i < linea.length(); i++) { //--Agrega los tokens al arreglo--//
                    if (!" ".equals(lineavec[i])) { //--Agrega los tokens al arreglo--//
                        if (";".equals(lineavec[i+1])) { //--Agrega los tokens al arreglo--//
                            tokens[conttokens] = "" + tokens[conttokens] + lineavec[i];
                            conttokens++; //--Agrega los tokens al arreglo--//
                            tokens[conttokens] = "" + lineavec[i+1];
                            i++; //--Agrega los tokens al arreglo--//
                        } else tokens[conttokens] = "" + tokens[conttokens] + lineavec[i];
                    } else conttokens++;//--Agrega los tokens al arreglo--//
                }
        ...
        tablaopsides[0][0] = "+"; tablaopsides[0][1] = "OPA01"; //define los operadores aritmeticos
        tablaopsides[1][0] = "-"; tablaopsides[1][1] = "OPA02"; //define los operadores aritmeticos
        tablaopsides[2][0] = "*"; tablaopsides[2][1] = "OPA03"; //define los operadores aritmeticos
        tablaopsides[3][0] = "/"; tablaopsides[3][1] = "OPA04"; //define los operadores aritmeticos
        tablaopsides[4][0] = "%"; tablaopsides[4][1] = "OPA05"; //define los operadores aritmeticos
        
        tablaopsrelides[0][0] = "="; tablaopsrelides[0][1] = "OPR01";  //define los operadores relacionales
        tablaopsrelides[1][0] = "<"; tablaopsrelides[1][1] = "OPR02"; //define los operadores relacionales
        tablaopsrelides[2][0] = ">"; tablaopsrelides[2][1] = "OPR03"; //define los operadores relacionales
        tablaopsrelides[3][0] = "<="; tablaopsrelides[3][1] = "OPR04";//define los operadores relacionales
        tablaopsrelides[4][0] = ">="; tablaopsrelides[4][1] = "OPR05";//define los operadores relacionales
        tablaopsrelides[5][0] = "=="; tablaopsrelides[5][1] = "OPR06";//define los operadores relacionales
        tablaopsrelides[6][0] = "!="; tablaopsrelides[6][1] = "OPR07";//define los operadores relacionales
        tablaopsrelides[7][0] = "||"; tablaopsrelides[7][1] = "OPR08";//define los operadores relacionales
        
        // --Insertar valores en tabla simbolos ciclo WHILE --//
        for (int x = 0; x < contlineatripletas; x++) {// --Insertar valores en tabla simbolos ciclo WHILE --//
            System.out.println(lineastripletas[x]);// --Insertar valores en tabla simbolos ciclo WHILE --//
            //--Separa todos los caracteres de la linea--//
            for (int i = 0; i < lineastripletas[x].length(); i++) lineavec2[i] = "" + lineastripletas[x].charAt(i);//--Separa todos los caracteres de la linea--//
            //--Cuenta los espacios para saber el numero de tokens--//
            for (int i = 0; i < lineastripletas[x].length(); i++) {    //--Cuenta los espacios para saber el numero de tokens--//
            ...
            conttokens2 = 0;
            //--Agrega los tokens al arreglo--//
            for (int i = 0; i < lineastripletas[x].length(); i++) { //--Agrega los tokens al arreglo--//
                if (!" ".equals(lineavec2[i])) {//--Agrega los tokens al arreglo--//
                    if (";".equals(lineavec2[i+1])) {//--Agrega los tokens al arreglo--//
                        tokens2[conttokens2] = "" + tokens2[conttokens2] + lineavec2[i];
                        conttokens2++;//--Agrega los tokens al arreglo--//
                        tokens2[conttokens2] = "" + lineavec2[i+1];
                        i++;//--Agrega los tokens al arreglo--//
                    } else tokens2[conttokens2] = "" + tokens2[conttokens2] + lineavec2[i];
                } else conttokens2++;//--Agrega los tokens al arreglo--//
            }
            //--Recorre cada token de las tripletas--//
            for (int i = 0; (i < conttokens2+1 && !";".equals(tokens2[i])); i++) { //--Recorre cada token de las tripletas--//
                for (String tipodato : tipodatos) { //--Recorre cada token de las tripletas--//
                    if (tokens2[0].equals(tipodato)) { //--Recorre cada token de las tripletas--//
                        tablatripletas[conttrip][0] = "" + (conttrip); //--Recorre cada token de las tripletas--//
                        tablatripletas[conttrip][1] = "T" + contT; //--Recorre cada token de las tripletas--//
                        tablatripletas[conttrip][2] = "CE" + contC; //--Recorre cada token de las tripletas--//
                        tablatripletas[conttrip][3] = "="; //--Recorre cada token de las tripletas--//
                        tablatripletas[conttrip+1][0] = "" + (conttrip + 1); //--Recorre cada token de las tripletas--//
                        for (String[] tablasimbolo : tablasimbolos) { //--Recorre cada token de las tripletas--//
                            if (tokens2[1].equals(tablasimbolo[2])) { //--Recorre cada token de las tripletas--//
                                tablatripletas[conttrip+1][1] = tablasimbolo[4]; //--Recorre cada token de las tripletas--//
                            }
                        }
...
//                    tablatripletas[conttrip][3] = "" + (apuntadorvueltafor + 1); 
    ...
    private void initComponents() {
        ...
        PanelGeneral.setBackground(new java.awt.Color(221, 160, 221));

        PanelSimbolos.setBackground(new java.awt.Color(221, 160, 221));
        ...
        PanelCodigo.setBackground(new java.awt.Color(221, 160, 221));
        ...
        PanelErrores.setBackground(new java.awt.Color(221, 160, 221));
        ...
        PanelBoton.setBackground(new java.awt.Color(221, 160, 221));
        ...
        BtnDesplegar.setBackground(new java.awt.Color(102, 205, 170));
        BtnDesplegar.setFont(new java.awt.Font("NSimSun", 1, 18)); // NOI18N
        BtnDesplegar.setForeground(new java.awt.Color(51, 51, 51));
        BtnDesplegar.setText("Ejecución");
        ...
        PanelTripletas.setBackground(new java.awt.Color(221, 160, 221));
        ...
        jLabel1.setText("Compilador e interprete (lexico, semantico y sintactico)");
